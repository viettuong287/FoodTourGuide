...
namespace Api.Migrations
{
    ...
    [Migration("20260415102058_ReplaceQrExpiryAtWithValidDays")]
    partial class ReplaceQrExpiryAtWithValidDays
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Domain.Entities.DevicePreference", b =>
                {
                    ...
                    b.ToTable("DevicePreferences", (string)null);
                });
            ...
            modelBuilder.Entity("Api.Domain.Entities.ScanLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("HasScannedQr")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<DateTime>("LastQrScanAt")
                        .HasColumnType("datetime2(3)");
                    ...
                    b.Property<DateTime>("QrSessionExpiry")
                        .HasColumnType("datetime2(3)");

                    b.HasKey("Id");

                    b.HasIndex("DeviceId", "LastQrScanAt")
            ...
            modelBuilder.Entity("Api.Domain.Entities.DevicePreference", b =>
                {
                    b.HasOne("Api.Domain.Entities.Language", "Language")
                        .WithMany("DevicePreferences")
                        .HasForeignKey("LanguageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Api.Domain.Entities.TtsVoiceProfile", "VoiceProfile")
                        .WithMany()
            ...
            modelBuilder.Entity("Api.Domain.Entities.Language", b =>
                {
                    b.Navigation("DevicePreferences");
